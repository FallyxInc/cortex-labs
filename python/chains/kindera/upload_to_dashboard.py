        ...
        for file in os.listdir(target_path):
            if file.endswith('merged.csv') or file.endswith('follow.csv'):
                ...
                if filename.endswith('merged.csv'):
                    ...
                    print(f"Successfully uploaded to firebase at {home_id}/behaviours")
                elif filename.endswith('follow.csv'):
                    print("Uploading to follow")
                    upload_csv_to_firebase(filename, f'{home_id}/follow', year, month)
                    print(f"Successfully uploaded to firebase at {home_id}/follow")
    else:
        files_by_dashboard = {}
            ...
            for filename, year, month in files:
                ...
                if dashboard != 'unknown':
                    if filename.endswith('merged.csv'):
                        ...
                        print(f"Successfully uploaded to firebase at {dashboard}/behaviours")
                    elif filename.endswith('follow.csv'):
                        print("Uploading to follow")
                        upload_csv_to_firebase(filename, f'{dashboard}/follow', year, month)
                        print(f"Successfully uploaded to firebase at {dashboard}/follow")
                else:
