...
def process_excel_file(home_name, input_file, output_file=None):
    """
...
def main(home_name: str = None):
    ...
    for xls_file in xls_files:
        ...
        try:
            process_excel_file(home_name, xls_path, None)  # output_file not used anymore, we save in process_excel_file
