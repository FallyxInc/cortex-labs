...
export default function HomeCard({
	...
	const borderColor =
		colorIndex % 2 === 0 ? 'border-l-cyan-500' : 'border-l-green-500';
	...
	return (
		...
		>
			<h3
				className="font-semibold text-gray-900 text-sm mb-3 truncate"
				title={home.homeName}
			>
				{home.homeName}
			</h3>
			...
			<div className="text-xs text-gray-600 mb-3">Behaviour Incidents</div>
			...
			<div className="space-y-2 text-xs border-t border-gray-100 pt-3">
				...
				{home.hydrationMissed3Days !== undefined && (
					<div className="flex justify-between items-center">
						...
						<span
							className={`font-semibold ${home.hydrationMissed3Days > 0 ? 'text-red-600' : 'text-gray-600'}`}
						>
